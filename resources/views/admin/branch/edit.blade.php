              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputArabicName" placeholder="Enter Arabic Name" name="name_ar" value="{{$branch->name_ar}}">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEnglishName">English Name</label>
                      <input type="text" class="form-control" id="exampleInputEnglishName" placeholder="Enter English Name" name="name_en" value="{{$branch->name_en}}">
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="exampleInputCity" name="city_id">
                        @foreach($cities as $city)
                          <option value="{{$city->id}}" {{ $branch->city_id == $city->id ? 'selected' : '' }}>{{$city->name_en}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="exampleInputArea" name="area_id">
                        @foreach($areas as $area)
                          <option value="{{$area->id}}" {{ $branch->area_id == $area->id ? 'selected' : '' }}>{{$area->name_en}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <div class="icheck-primary d-inline">
                        @if(str_contains($branch->service_type, "delivery"))
                            <input type="checkbox" id="delivery" name="service_type[]" value="delivery" checked>
                          @else
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <div class="icheck-primary d-inline">
                        @if(str_contains($branch->service_type, "takeaway"))
                            <input type="checkbox" id="takeaway" name="service_type[]" value="takeaway" checked>
                        @else
